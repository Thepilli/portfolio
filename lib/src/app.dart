    ...
    return MaterialApp(
      ...
      theme: FlexThemeData.light(
        colors: const FlexSchemeColor(
          primary: Color(0xFFFAFAF8), //background
          primaryContainer: Color(0xff0074b7),
          secondary: Color(0xFFF3E47F), //chips and top/bot/side drawers
          secondaryContainer: Color(0xff003b73),
          tertiary: Color(0xFFF8F591), //borders & opacity container
          tertiaryContainer: Color(0xff000000),
          appBarColor: Color(0xff003b73),
          error: Color(0xffb00020),
        ),
        textTheme: const TextTheme(
          displayLarge: TextStyle(fontSize: 57), //title
          displayMedium: TextStyle(fontSize: 45), //mobile title
          displaySmall: TextStyle(fontSize: 36), //nada
          headlineLarge: TextStyle(fontSize: 32),
          headlineMedium: TextStyle(fontSize: 28), //mobile navidgation
          headlineSmall: TextStyle(fontSize: 26),
          titleLarge: TextStyle(fontSize: 24), //position and headers
          titleMedium: TextStyle(fontSize: 18), //jobtitle, resume and language, dektop navigation
          titleSmall: TextStyle(fontSize: 16), //nada
          bodyLarge: TextStyle(fontSize: 18), //subposition and about me
          bodyMedium: TextStyle(fontSize: 16), // years, body
          bodySmall: TextStyle(fontSize: 14), //nada
        ),
      ...
      darkTheme: FlexThemeData.dark(
        colors: const FlexSchemeColor(
          primary: Color(0xFF273536),
          primaryContainer: Color(0xff41729f),
          secondary: Color(0xFF226574),
          secondaryContainer: Color(0xffc3e0e5),
          tertiary: Color(0xFF03C9DF),
          tertiaryContainer: Color(0xff000000),
