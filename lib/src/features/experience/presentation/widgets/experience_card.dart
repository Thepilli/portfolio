...
class ExperienceCard extends ConsumerWidget {
                ...
                if (Responsive.isMobile(context))
                  Column(
                    ...
                    children: [
                      ...
                      if (experience.company != null) gapH12 else gapH4,
                      gapH4,
                      Text(
                        "${experience.startDate} - ${experience.endDate}",
                        style: Theme.of(context).textTheme.bodyMedium,
  ...
  Widget _buildCompany(BuildContext context) {
    if (experience.company == null) return const SizedBox.shrink();
    return Text(experience.company!, style: Theme.of(context).textTheme.bodyMedium);
  }
}
