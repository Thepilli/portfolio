      ...
      title: Row(
        children: [
          ref.watch(darkModeProvider)
              ? Image.asset(
                  'assets/images/Zeyada_White.png',
                  height: 40,
                )
              : Image.asset(
                  'assets/images/Zeyada_Black.png',
                  height: 40,
                ),
          ...
          Row(
            children: [
              ...
              AppBarButton(
                ...
                onPressed: () {
                  final experienceSectionKey = ref.watch(experienceSectionKeyProvider);
              ...
              AppBarButton(
                ...
                onPressed: () {
                  final projectSectionKey = ref.watch(projectSectionKeyProvider);
